...
ActiveRecord::Schema.define(version: 20170214010103) do

  create_table "comments", force: :cascade do |t|
    t.string   "text"
    t.integer  "author_id",       null: false
    t.integer  "comment_id_id"
    t.string   "comment_id_type"
    t.datetime "created_at"
    t.datetime "updated_at"
  end

  add_index "comments", ["comment_id_type", "comment_id_id"], name: "index_comments_on_comment_id_type_and_comment_id_id"
